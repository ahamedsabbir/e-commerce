                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap">
                                            ...
                                            <tr>
                                                <td class="text-center"><img style="width:40px;" src="{{ asset('/uploads/'.$subcategory_value->icon) }}" /></td>
                                                <td>{{ $subcategory_value->name }}</td>
                                                <td>{{ $subcategory_value->title }}</td>
                                                <td>{{ App\Models\Category::find($subcategory_value->category)->name }}</td>
                                                <td>{{ naturalDate($subcategory_value->crited_at) }}</td>
													...
													<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
													  <div class="btn-group" role="group">
														...
														<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
														  <li><a class="dropdown-item" href="{{ url('dashboard/subcategory/update/page/'.$subcategory_value->id) }}">Edit</a></li>
														  <li><a class="dropdown-item" href="{{ url('dashboard/subcategory/remove/'.$subcategory_value->id) }}">Delete</a></li>
														</ul>
													  </div>
													</div>
												</td>
