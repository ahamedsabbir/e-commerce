                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('dashboard/subcategory/update/function/'.$subcategory->id) }}" method="post"  enctype="multipart/form-data">
											...
											<div class="mb-3">
                                                ...
                                                <input type="text" class="form-control" name="name" id="name" value="{{ $subcategory->name }}" data-parsley-trigger="change" required="">
                                            </div>
                                            <div class="mb-3">
                                                <label for="title" class="form-label">Title * :</label>
                                                <input type="text" id="title" class="form-control" name="title" value="{{ $subcategory->title }}" data-parsley-trigger="change" required="">
                                            </div>
											<div class="mb-3">
											...
											<div class="mb-3">
                                                ...
                                                <input type="text" id="fonticon" class="form-control" name="font_icon" value="{{ $subcategory->font_icon }}" data-parsley-trigger="change" required="">
                                            </div>
                                            <div class="mb-3">
							...
							<div class="col-4">
								<img style="width:100%" src="{{ asset('/uploads/'.$subcategory->icon) }}" />
							<div>
                        </div>
                        <!-- end row-->     
