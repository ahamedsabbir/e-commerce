		...
		<ul class="list-unstyled topnav-menu float-end mb-0">
			...
			<li class="dropdown d-inline-block d-lg-none">
				...
				<div class="dropdown-menu dropdown-lg dropdown-menu-end p-0">
					<form action="{{ url('/dashboard/product/search') }}" method="get" class="p-3">
						@csrf
						<input type="text" name="keyword" class="form-control" placeholder="Search ..." aria-label="Recipient's username">
					</form>
				</div>
			</li>
