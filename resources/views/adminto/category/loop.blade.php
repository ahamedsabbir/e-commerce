                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap">
                                            ...
                                            <tr>
                                                <td class="text-center"><img style="width:40px;" src="{{ asset('/uploads/'.$category_value->icon) }}" /></td>
                                                <td>{{ $category_value->name }}</td>
                                                <td>{{ $category_value->title }}</td>
                                                <td>{{ naturalDate($category_value->crited_at) }}</td>
													...
													<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
													  <div class="btn-group" role="group">
														...
														<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
														  <li><a class="dropdown-item" href="{{ url('dashboard/category/update/page/'.$category_value->id) }}">Edit</a></li>
														  <li><a class="dropdown-item" href="{{ url('dashboard/category/remove/'.$category_value->id) }}">Delete</a></li>
														</ul>
													  </div>
													</div>
												</td>
