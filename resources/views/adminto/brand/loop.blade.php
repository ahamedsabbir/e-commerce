                                ...
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <table id="datatable" class="table table-bordered dt-responsive table-responsive nowrap">
                                            ...
                                            <tr>
                                                <td class="text-center"><img style="width:40px;" src="{{ asset('/uploads/'.$brand_value->icon) }}" /></td>
                                                <td>{{ $brand_value->name }}</td>
                                                <td>{{ $brand_value->title }}</td>
                                                <td>{{ naturalDate($brand_value->crited_at) }}</td>
													...
													<div class="btn-group" role="group" aria-label="Button group with nested dropdown">
													  <div class="btn-group" role="group">
														...
														<ul class="dropdown-menu" aria-labelledby="btnGroupDrop1">
														  <li><a class="dropdown-item" href="{{ url('dashboard/brand/update/page/'.$brand_value->id) }}">Edit</a></li>
														  <li><a class="dropdown-item" href="{{ url('dashboard/brand/remove/'.$brand_value->id) }}">Delete</a></li>
														</ul>
													  </div>
													</div>
												</td>
