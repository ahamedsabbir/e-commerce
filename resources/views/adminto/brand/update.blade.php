                ...
                <div class="content">
                    ...
                    <div class="container-fluid">
                        ...
                        <div class="row">
                            <div class="col-8">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="{{ url('dashboard/brand/update/function/'.$brand->id) }}" method="post"  enctype="multipart/form-data">
                                            @csrf
											<div class="mb-3">
                                                <label for="name" class="form-label">Name * :</label>
                                                <input type="text" class="form-control" name="name" id="name" value="{{ $brand->name }}" data-parsley-trigger="change" required="">
                                            </div>
                                            <div class="mb-3">
                                                <label for="title" class="form-label">Title * :</label>
                                                <input type="text" id="title" class="form-control" name="title" value="{{ $brand->title }}" data-parsley-trigger="change" required="">
                                            </div>
											<div class="mb-3">
                                                <label for="fonticon" class="form-label">Font Icon * :</label>
                                                <input type="text" id="fonticon" class="form-control" name="font_icon" value="{{ $brand->font_icon }}" data-parsley-trigger="change" required="">
                                            </div>
                                            <div class="mb-3">
							...
							<div class="col-4">
								<img style="width:100%" src="{{ asset('/uploads/'.$brand->icon) }}" />
							<div>
                        </div>
                        <!-- end row-->     
