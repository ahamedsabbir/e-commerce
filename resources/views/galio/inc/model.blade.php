					...
					<div class="row">
						<div class="col-lg-5">
							...
							<div class="pro-nav slick-padding2 slick-arrow-style_2">
								<div class="pro-nav-thumb"><img src="{{ asset('galio/assets/img/product/product-details-img1.jpg') }}"
										alt="" /></div>
								...
								<div class="pro-nav-thumb"><img src="{{ asset('galio/assets/img/product/product-details-img4.jpg') }}"
										alt="" /></div>
								<div class="pro-nav-thumb"><img src="{{ asset('galio/assets/img/product/product-details-img5.jpg') }}"
										alt="" /></div>
							</div>
						</div>
						<div class="col-lg-7">
